...
export function BookingCard() {
    ...
    return (
        <div className="bg-white rounded-[32px] shadow-[0_6px_16px_rgba(0,0,0,0.12)] border border-[#dddddd] p-8 w-full max-w-[480px] mx-auto sticky top-24 z-30">
            ...
            <div className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-3 text-[#222222] text-sm">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <a
                        href="https://wa.me/573021025621?text=Hola%20La%20Juana%2C%20tengo%20una%20duda%20sobre%20las%20fechas%20y%20el%20proceso%20de%20reserva."
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-bold text-[#25D366] hover:underline transition-all flex items-center gap-1.5"
                    >
