    ...
    return (
        <section id="experiencias" className="py-24 md:py-32 px-6 relative overflow-hidden group/section">
            ...
            <div
                ...
                style={{
                    backgroundImage: 'url("/imagenes/espacios/IMG_5223.webp")',
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-20">
                    <motion.p
                        ...
                        className="text-white font-serif italic tracking-[0.4em] text-xs mb-6 uppercase shadow-sm"
                    >
                    ...
                    <motion.h2
                        ...
                        className="text-4xl md:text-7xl font-serif text-white mb-8 italic drop-shadow-lg"
                    >
                    ...
                    {experiences.map((exp, i) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-x-0 bottom-0 p-8 text-center text-white">
                                <h3 className="text-2xl md:text-3xl font-serif italic mb-2 tracking-tight group-hover:mb-4 transition-all duration-500 underline underline-offset-8 decoration-[#9a7d45]/0 group-hover:decoration-[#9a7d45]">
                                    {exp.title}
                                </h3>
                                <p className="text-white/60 text-xs md:text-sm font-serif italic opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                                    {exp.desc}
                                </p>
                            </div>
