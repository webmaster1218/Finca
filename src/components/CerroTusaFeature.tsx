        ...
        <section className="relative py-32 bg-[#1a3c34] overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <motion.div
                    ...
                    className="text-left"
                >
                    <p className="text-[#9a7d45] font-serif italic tracking-[0.4em] text-xs mb-6 uppercase">La Gran Pirámide Natural</p>
                    <h2 className="text-4xl md:text-6xl font-serif text-white mb-10 italic leading-tight">
                        Vistas que cuentan <br /> una historia
                    </h2>

                    <div className="w-16 h-[1px] bg-[#9a7d45] mb-8" />

                    <p className="text-white/80 text-xl mb-12 leading-relaxed font-serif italic max-w-lg">
                    ...
                    <a href="#finca" className="px-10 py-3 bg-white text-[#1a3c34] font-serif italic hover:bg-[#fdfaf6] transition-all inline-flex items-center gap-4 group border border-white/20 shadow-lg">
                ...
                >
                    ...
                    <div className="absolute bottom-10 -right-4 z-20 bg-[#fdfaf6] p-6 shadow-xl border-l-4 border-[#9a7d45] max-w-[200px]">
                        <p className="font-serif italic text-[#1a3c34] text-sm italic">
