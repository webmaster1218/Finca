    ...
    return (
        <section id="hero" className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
            ...
            <div className="relative z-20 text-center px-6 max-w-4xl mx-auto border-y border-[#fffbf0]/20 py-16">
                ...
                >
                    <a
                        href="https://wa.me/573021025621?text=Hola%20La%20Juana%2C%20quisiera%20recibir%20informaci%C3%B3n%20para%20reservar."
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-8 py-3 bg-[#25D366] hover:bg-[#20ba5a] text-white font-serif italic text-sm tracking-wide transition-all duration-300 shadow-xl flex items-center gap-2.5 border border-emerald-400/30 group"
                    >
                        <svg
                            viewBox="0 0 24 24"
                        ...
                        <span>{t('hero.whatsapp_cta') || 'Hablar por WhatsApp'}</span>
                    </a>
                </motion.div>
            </div>
        </section>
